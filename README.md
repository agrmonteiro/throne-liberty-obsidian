# Throne & Liberty — Tier2 Command Lab

> **Beta pública** — ferramenta desktop para análise e otimização de personagens no Throne & Liberty.

![Infográfico Tier2 Command Lab](./docs/images/tier2-command-lab-infografico.png)
...
**Tier2 Command Lab** é um app desktop para jogadores do Throne & Liberty que querem ir além do feeling e entender seus personagens com dados reais.
...
- Atualização de dados via Questlog: faça uma nova leitura dos dados da build quando precisar
...
- **Ranking de Boss** — ranking de desempenho em chefes com foco em DPS, uptime e consistência
...
> O instalador já inclui e configura automaticamente os componentes necessários para importação e leitura de dados. Não é preciso instalar Python separadamente para uso normal do app.
...
- Discord (Agrmonteiro): [https://discord.gg/NYSg2bYZ](https://discord.gg/NYSg2bYZ)
